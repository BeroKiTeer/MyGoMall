...
func (x *Product) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	x.OriginalPrice, offset, err = fastpb.ReadFloat(buf, _type)
	return offset, err
}
...
func (x *Product) fastReadField7(buf []byte, _type int8) (offset int, err error) {
	x.Images, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetProductsBatchReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetProductsBatchResp[number], err)
}

func (x *GetProductsBatchResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v Product
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *Product) fastWriteField5(buf []byte) (offset int) {
	...
	offset += fastpb.WriteFloat(buf[offset:], 5, x.GetOriginalPrice())
	return offset
}
...
func (x *Product) fastWriteField7(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 7, x.GetImages())
	return offset
}
...
func (x *Product) fastWriteField8(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint32(buf[offset:], 8, x.GetStatus())
	return offset
}
...
func (x *Product) fastWriteField9(buf []byte) (offset int) {
	...
	for i := range x.GetCategories() {
		offset += fastpb.WriteString(buf[offset:], 9, x.GetCategories()[i])
	}
	return offset
}
...
func (x *GetProductsBatchReq) fastWriteField1(buf []byte) (offset int) {
	if len(x.Ids) == 0 {
		return offset
	}
...
func (x *GetProductsBatchResp) fastWriteField1(buf []byte) (offset int) {
	if x.Products == nil {
		return offset
	}
	for i := range x.GetProducts() {
...
func (x *Product) sizeField5() (n int) {
	...
	n += fastpb.SizeFloat(5, x.GetOriginalPrice())
	return n
}
...
func (x *Product) sizeField7() (n int) {
	...
	n += fastpb.SizeString(7, x.GetImages())
	return n
}
...
func (x *Product) sizeField8() (n int) {
	...
	n += fastpb.SizeUint32(8, x.GetStatus())
	return n
}
...
func (x *Product) sizeField9() (n int) {
	...
	for i := range x.GetCategories() {
		n += fastpb.SizeString(9, x.GetCategories()[i])
	}
	return n
}
...
func (x *GetProductsBatchReq) sizeField1() (n int) {
	if len(x.Ids) == 0 {
		return n
	}
...
func (x *GetProductsBatchResp) sizeField1() (n int) {
	if x.Products == nil {
		return n
	}
	for i := range x.GetProducts() {
...
var fieldIDToName_GetProductsBatchReq = map[int32]string{
	1: "Ids",
}

var fieldIDToName_GetProductsBatchResp = map[int32]string{
	1: "Products",
}
