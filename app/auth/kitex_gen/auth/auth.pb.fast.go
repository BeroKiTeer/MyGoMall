...
func (x *RefreshTokenReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Seconds, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}
...
func (x *RefreshTokenResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.NewToken, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *GetTokenReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetTokenReq[number], err)
}

func (x *GetTokenReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.UserID, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}

func (x *GetTokenResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetTokenResp[number], err)
}

func (x *GetTokenResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Token, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *RefreshTokenReq) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 2, x.GetSeconds())
	return offset
}
...
func (x *RefreshTokenResp) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 1, x.GetNewToken())
	return offset
}

func (x *GetTokenReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *GetTokenReq) fastWriteField1(buf []byte) (offset int) {
	if x.UserID == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 1, x.GetUserID())
...
func (x *GetTokenResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *GetTokenResp) fastWriteField1(buf []byte) (offset int) {
	if x.Token == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetToken())
...
func (x *RefreshTokenReq) sizeField2() (n int) {
	...
	n += fastpb.SizeInt32(2, x.GetSeconds())
	return n
}
...
func (x *RefreshTokenResp) sizeField1() (n int) {
	...
	n += fastpb.SizeString(1, x.GetNewToken())
	return n
}

func (x *GetTokenReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *GetTokenReq) sizeField1() (n int) {
	if x.UserID == 0 {
		return n
	}
	n += fastpb.SizeInt32(1, x.GetUserID())
...
func (x *GetTokenResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *GetTokenResp) sizeField1() (n int) {
	if x.Token == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetToken())
...
var fieldIDToName_GetTokenReq = map[int32]string{
	1: "UserID",
}

var fieldIDToName_GetTokenResp = map[int32]string{
	1: "Token",
}
