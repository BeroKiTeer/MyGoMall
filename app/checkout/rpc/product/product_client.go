...
func (c *clientImpl) GetProductsBatch(ctx context.Context, Req *product.GetProductsBatchReq, callOptions ...callopt.Option) (r *product.GetProductsBatchResp, err error) {
	return c.kitexClient.GetProductsBatch(ctx, Req, callOptions...)
}
