...
type Address struct {
	...
	State           string `protobuf:"bytes,3,opt,name=state,proto3" json:"state,omitempty"`                                            // 省
	Country         string `protobuf:"bytes,4,opt,name=country,proto3" json:"country,omitempty"`                                        // 国家
	TelephoneNumber string `protobuf:"bytes,5,opt,name=telephone_number,json=telephoneNumber,proto3" json:"telephone_number,omitempty"` // 收件人电话
	Name            string `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty"`                                              // 收件人姓名
}
...
func (x *Address) GetTelephoneNumber() string {
	if x != nil {
...
type PlaceOrderReq struct {
	...
	UserCurrency string       `protobuf:"bytes,2,opt,name=user_currency,json=userCurrency,proto3" json:"user_currency,omitempty"` // 用户的货币类型
	Address      *Address     `protobuf:"bytes,3,opt,name=address,proto3" json:"address,omitempty"`                               // 用户的地址信息
	Email        string       `protobuf:"bytes,4,opt,name=email,proto3" json:"email,omitempty"`                                   // 用户的邮箱
	OrderItems   []*OrderItem `protobuf:"bytes,5,rep,name=order_items,json=orderItems,proto3" json:"order_items,omitempty"`       // 订单中的商品列表
}
...
type OrderItem struct {
	...
	Cost      int64 `protobuf:"varint,3,opt,name=cost,proto3" json:"cost,omitempty"`                            // 商品的单价。
}
...
type PlaceOrderResp struct {
	...
	Order *OrderResult `protobuf:"bytes,1,opt,name=order,proto3" json:"order,omitempty"` // 新建的订单信息
}
...
type Order struct {
	...
	OrderItems   []*OrderItem `protobuf:"bytes,1,rep,name=order_items,json=orderItems,proto3" json:"order_items,omitempty"`       // 订单中的商品列表
	...
	UserCurrency string       `protobuf:"bytes,4,opt,name=user_currency,json=userCurrency,proto3" json:"user_currency,omitempty"` // 货币类型
	Address      *Address     `protobuf:"bytes,5,opt,name=address,proto3" json:"address,omitempty"`                               // 地址信息
	Email        string       `protobuf:"bytes,6,opt,name=email,proto3" json:"email,omitempty"`                                   // 邮箱
	CreatedAt    string       `protobuf:"bytes,7,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`          // 订单创建时间
	UpdateAt     string       `protobuf:"bytes,8,opt,name=update_at,json=updateAt,proto3" json:"update_at,omitempty"`             // 订单最后更新时间
}
...
type ListOrderResp struct {
	...
	Orders []*Order `protobuf:"bytes,1,rep,name=orders,proto3" json:"orders,omitempty"` // 用户的订单列表
}
...
type MarkOrderPaidReq struct {
	...
	TransactionId string `protobuf:"bytes,1,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"` // 交易 ID
	OrderId       string `protobuf:"bytes,2,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`                   // 订单 ID
}
...
func (x *MarkOrderPaidReq) GetTransactionId() string {
	if x != nil {
...
type MarkOrderPaidResp struct {
	...
	Status string `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // 状态，"success" 或 "error"。
}
...
type UpdateOrderReq struct {
	...
	OrderId string   `protobuf:"bytes,1,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"` // 订单 ID
	Address *Address `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"`                // 新的地址信息
	Email   string   `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`                    // 新的邮箱
}
...
// 显示订单详情的请求消息
type ShowOrderDetailReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ShowOrderDetailReq) Reset() {
	*x = ShowOrderDetailReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *ShowOrderDetailReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShowOrderDetailReq) ProtoMessage() {}

func (x *ShowOrderDetailReq) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShowOrderDetailReq.ProtoReflect.Descriptor instead.
func (*ShowOrderDetailReq) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{14}
}

func (x *ShowOrderDetailReq) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
// 显示订单详情的响应消息
type ShowOrderDetailResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ShowOrderDetailResp) Reset() {
	*x = ShowOrderDetailResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *ShowOrderDetailResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShowOrderDetailResp) ProtoMessage() {}

func (x *ShowOrderDetailResp) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShowOrderDetailResp.ProtoReflect.Descriptor instead.
func (*ShowOrderDetailResp) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{15}
}

func (x *ShowOrderDetailResp) GetOrderItems() []*OrderItem {
	if x != nil {
		return x.OrderItems
	}
	return nil
...
var file_order_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x65, 0x72, 0x22, 0xb3, 0x01, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x29, 0x0a, 0x10, 0x74,
	0x65, 0x6c, 0x65, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x68, 0x6f, 0x6e, 0x65,
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xc0, 0x01, 0x0a, 0x0d, 0x50,
	...
	0x6d, 0x52, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x5a, 0x0a,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x22, 0x28, 0x0a, 0x0b, 0x4f, 0x72, 0x64,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x8f, 0x02, 0x0a, 0x05, 0x4f, 0x72, 0x64,
	...
	0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x74, 0x22, 0x35, 0x0a, 0x0d, 0x4c, 0x69,
	...
	0x73, 0x22, 0x54, 0x0a, 0x10, 0x4d, 0x61, 0x72, 0x6b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x61,
	0x69, 0x64, 0x52, 0x65, 0x71, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2b, 0x0a, 0x11, 0x4d, 0x61, 0x72, 0x6b, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x50, 0x61, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16, 0x0a, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x22, 0x6b, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72,
	...
	0x6c, 0x22, 0x2b, 0x0a, 0x0f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2b, 0x0a, 0x0f, 0x43,
	0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x18,
	0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x2f, 0x0a, 0x12, 0x53, 0x68, 0x6f, 0x77,
	...
	0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x48, 0x0a, 0x13, 0x53, 0x68, 0x6f,
	0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70,
	...
	0x65, 0x6d, 0x73, 0x32, 0x8b, 0x03, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x4f, 0x72, 0x64,
	...
	0x2e, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12,
	0x36, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x6f,
	...
	0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x42, 0x0a, 0x0d, 0x4d, 0x61, 0x72, 0x6b, 0x4f,
	...
	0x64, 0x65, 0x72, 0x50, 0x61, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70, 0x12, 0x3c, 0x0a, 0x0b, 0x55,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x3c, 0x0a, 0x0b, 0x43, 0x61, 0x6e,
	...
	,
...
var file_order_proto_goTypes = []interface{}{
	...
	(*ShowOrderDetailReq)(nil),  // 14: order.ShowOrderDetailReq
	(*ShowOrderDetailResp)(nil), // 15: order.ShowOrderDetailResp
}
var file_order_proto_depIdxs = []int32{
	...
	2,  // 3: order.Order.order_items:type_name -> order.OrderItem
	0,  // 4: order.Order.address:type_name -> order.Address
	6,  // 5: order.ListOrderResp.orders:type_name -> order.Order
	0,  // 6: order.UpdateOrderReq.address:type_name -> order.Address
	2,  // 7: order.ShowOrderDetailResp.order_items:type_name -> order.OrderItem
	...
	10, // 11: order.OrderService.UpdateOrder:input_type -> order.UpdateOrderReq
	12, // 12: order.OrderService.CancelOrder:input_type -> order.CancelOrderReq
	14, // 13: order.OrderService.ShowOrderDetail:input_type -> order.ShowOrderDetailReq
	...
	9,  // 16: order.OrderService.MarkOrderPaid:output_type -> order.MarkOrderPaidResp
	11, // 17: order.OrderService.UpdateOrder:output_type -> order.UpdateOrderResp
	13, // 18: order.OrderService.CancelOrder:output_type -> order.CancelOrderResp
	15, // 19: order.OrderService.ShowOrderDetail:output_type -> order.ShowOrderDetailResp
...
func file_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_order_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShowOrderDetailReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_order_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShowOrderDetailResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type OrderService interface {
	...
	ShowOrderDetail(ctx context.Context, req *ShowOrderDetailReq) (res *ShowOrderDetailResp, err error)
}
