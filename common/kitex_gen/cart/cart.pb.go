...
type AddItemReq struct {
	...
	UserId uint32    `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // 用户ID
	Item   *CartItem `protobuf:"bytes,2,opt,name=item,proto3" json:"item,omitempty"`                    // 要添加的商品信息
}
...
type GetCartResp struct {
	...
	Cart *Cart `protobuf:"bytes,1,opt,name=cart,proto3" json:"cart,omitempty"` // 购物车详情
}
...
var file_cart_proto_rawDesc = []byte{
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x42, 0x65, 0x72, 0x6f, 0x4b, 0x69, 0x54, 0x65, 0x65, 0x72, 0x2f,
	0x4d, 0x79, 0x47, 0x6f, 0x4d, 0x61, 0x6c, 0x6c, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f,
