...
type Product struct {
	...
	Id            int64    `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                            // 商品 ID
...
type CreateProductResp struct {
	...
	ProductId int64 `protobuf:"varint,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"` // 创建的商品信息（包含生成的ID）
}
...
type DeleteProductReq struct {
	...
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // 要删除的商品ID
}
...
type GetProductsBatchReq struct {
	...
	Ids []int64 `protobuf:"varint,1,rep,packed,name=ids,proto3" json:"ids,omitempty"` // 要查询的商品ID列表。
}
...
var file_product_proto_rawDesc = []byte{
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x16, 0x0a,
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x3c, 0x0a, 0x0e, 0x47, 0x65, 0x74,
