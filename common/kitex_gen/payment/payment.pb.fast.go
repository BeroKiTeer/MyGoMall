...
func (x *CancelResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_CancelResp[number], err)
}

func (x *CancelResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Status, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ChargeByThirdPartyReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ChargeByThirdPartyReq[number], err)
}

func (x *ChargeByThirdPartyReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Amount, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}

func (x *ChargeByThirdPartyReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.OrderId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ChargeByThirdPartyReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}
...
func (x *ChargeByThirdPartyResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ChargeByThirdPartyResp[number], err)
}

func (x *ChargeByThirdPartyResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.TransactionId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *CancelResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *CancelResp) fastWriteField1(buf []byte) (offset int) {
	if x.Status == "" {
		return offset
	}
...
func (x *ChargeByThirdPartyReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ChargeByThirdPartyReq) fastWriteField1(buf []byte) (offset int) {
	if x.Amount == 0 {
		return offset
	}
	offset += fastpb.WriteInt64(buf[offset:], 1, x.GetAmount())
...
func (x *ChargeByThirdPartyReq) fastWriteField2(buf []byte) (offset int) {
	if x.OrderId == "" {
		return offset
	}
...
func (x *ChargeByThirdPartyReq) fastWriteField3(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
...
func (x *ChargeByThirdPartyReq) fastWriteField4(buf []byte) (offset int) {
	if x.Way == "" {
		return offset
	}
...
func (x *ChargeByThirdPartyResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ChargeByThirdPartyResp) fastWriteField1(buf []byte) (offset int) {
	if x.TransactionId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetTransactionId())
...
func (x *CancelResp) sizeField1() (n int) {
	if x.Status == "" {
		return n
	}
...
func (x *ChargeByThirdPartyReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ChargeByThirdPartyReq) sizeField1() (n int) {
	if x.Amount == 0 {
		return n
	}
	n += fastpb.SizeInt64(1, x.GetAmount())
...
func (x *ChargeByThirdPartyReq) sizeField2() (n int) {
	if x.OrderId == "" {
		return n
	}
...
func (x *ChargeByThirdPartyReq) sizeField3() (n int) {
	if x.UserId == 0 {
		return n
	}
...
func (x *ChargeByThirdPartyReq) sizeField4() (n int) {
	if x.Way == "" {
		return n
	}
...
func (x *ChargeByThirdPartyResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ChargeByThirdPartyResp) sizeField1() (n int) {
	if x.TransactionId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetTransactionId())
...
var fieldIDToName_CancelResp = map[int32]string{
	1: "Status",
}

var fieldIDToName_ChargeByThirdPartyReq = map[int32]string{
	1: "Amount",
	2: "OrderId",
	3: "UserId",
	4: "Way",
