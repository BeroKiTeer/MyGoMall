...
type CreditCardInfo struct {
	...
	CreditCardNumber          string `protobuf:"bytes,1,opt,name=credit_card_number,json=creditCardNumber,proto3" json:"credit_card_number,omitempty"`                               // 信用卡号
	CreditCardCvv             int32  `protobuf:"varint,2,opt,name=credit_card_cvv,json=creditCardCvv,proto3" json:"credit_card_cvv,omitempty"`                                       // 信用卡 CVV
	CreditCardExpirationYear  int32  `protobuf:"varint,3,opt,name=credit_card_expiration_year,json=creditCardExpirationYear,proto3" json:"credit_card_expiration_year,omitempty"`    // 信用卡到期年份
	CreditCardExpirationMonth int32  `protobuf:"varint,4,opt,name=credit_card_expiration_month,json=creditCardExpirationMonth,proto3" json:"credit_card_expiration_month,omitempty"` // 信用卡到期月份
}
...
type ChargeReq struct {
	...
	Amount     int64           `protobuf:"varint,1,opt,name=amount,proto3" json:"amount,omitempty"`                          // 支付金额
	CreditCard *CreditCardInfo `protobuf:"bytes,2,opt,name=credit_card,json=creditCard,proto3" json:"credit_card,omitempty"` // 信用卡信息
	OrderId    string          `protobuf:"bytes,3,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`          // 订单 ID
...
type CancelReq struct {
	...
	Id int32 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // 订单 ID
}
...
func (x *CancelResp) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
// 第三方支付请求
type ChargeByThirdPartyReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Way     string `protobuf:"bytes,4,opt,name=way,proto3" json:"way,omitempty"`
}

func (x *ChargeByThirdPartyReq) Reset() {
	*x = ChargeByThirdPartyReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChargeByThirdPartyReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChargeByThirdPartyReq) ProtoMessage() {}

func (x *ChargeByThirdPartyReq) ProtoReflect() protoreflect.Message {
	mi := &file_payment_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChargeByThirdPartyReq.ProtoReflect.Descriptor instead.
func (*ChargeByThirdPartyReq) Descriptor() ([]byte, []int) {
	return file_payment_proto_rawDescGZIP(), []int{5}
}

func (x *ChargeByThirdPartyReq) GetAmount() int64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *ChargeByThirdPartyReq) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *ChargeByThirdPartyReq) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ChargeByThirdPartyReq) GetWay() string {
	if x != nil {
		return x.Way
	}
	return ""
...
// 第三方支付相应
type ChargeByThirdPartyResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ChargeByThirdPartyResp) Reset() {
	*x = ChargeByThirdPartyResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChargeByThirdPartyResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChargeByThirdPartyResp) ProtoMessage() {}

func (x *ChargeByThirdPartyResp) ProtoReflect() protoreflect.Message {
	mi := &file_payment_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChargeByThirdPartyResp.ProtoReflect.Descriptor instead.
func (*ChargeByThirdPartyResp) Descriptor() ([]byte, []int) {
	return file_payment_proto_rawDescGZIP(), []int{6}
}

func (x *ChargeByThirdPartyResp) GetTransactionId() string {
	if x != nil {
		return x.TransactionId
	}
	return ""
...
var file_payment_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_payment_proto_goTypes = []interface{}{
	...
	(*CancelReq)(nil),              // 3: payment.CancelReq
	(*CancelResp)(nil),             // 4: payment.CancelResp
	(*ChargeByThirdPartyReq)(nil),  // 5: payment.ChargeByThirdPartyReq
	(*ChargeByThirdPartyResp)(nil), // 6: payment.ChargeByThirdPartyResp
}
var file_payment_proto_depIdxs = []int32{
	...
	3, // 2: payment.PaymentService.CancelPayment:input_type -> payment.CancelReq
	5, // 3: payment.PaymentService.ChargeByThirdParty:input_type -> payment.ChargeByThirdPartyReq
	2, // 4: payment.PaymentService.Charge:output_type -> payment.ChargeResp
	4, // 5: payment.PaymentService.CancelPayment:output_type -> payment.CancelResp
	6, // 6: payment.PaymentService.ChargeByThirdParty:output_type -> payment.ChargeByThirdPartyResp
...
func file_payment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_payment_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChargeByThirdPartyReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_payment_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChargeByThirdPartyResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type PaymentService interface {
	...
	CancelPayment(ctx context.Context, req *CancelReq) (res *CancelResp, err error)
	ChargeByThirdParty(ctx context.Context, req *ChargeByThirdPartyReq) (res *ChargeByThirdPartyResp, err error)
}
