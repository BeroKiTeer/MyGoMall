...
type CartItem struct {
	...
	ProductId uint32 `protobuf:"varint,1,opt,name=product_id,json=productId,proto3" form:"product_id" json:"product_id,omitempty" query:"product_id"` // 商品ID
...
type Cart struct {
	...
	UserId uint32      `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id,omitempty" query:"user_id"` // 用户ID
	Items  []*CartItem `protobuf:"bytes,2,rep,name=items,proto3" form:"items" json:"items,omitempty" query:"items"`                      // 购物车中的商品列表
}
...
type AddItemReq struct {
	...
	UserId uint32    `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id,omitempty" query:"user_id"` // 用户ID
	Item   *CartItem `protobuf:"bytes,2,opt,name=item,proto3" form:"item" json:"item,omitempty" query:"item"`                          // 要添加的商品信息
}
...
type GetCartResp struct {
	...
	Cart *Cart `protobuf:"bytes,1,opt,name=cart,proto3" form:"cart" json:"cart,omitempty" query:"cart"` // 购物车详情
}
...
var file_cart_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x15, 0x5a, 0x13, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x68,
	0x65, 0x72, 0x74, 0x7a, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x63, 0x61, 0x72, 0x74, 0x62, 0x06, 0x70,
