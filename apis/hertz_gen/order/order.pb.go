...
type Address struct {
	...
	StreetAddress   string `protobuf:"bytes,1,opt,name=street_address,json=streetAddress,proto3" form:"street_address" json:"street_address,omitempty" query:"street_address"`           // 街道地址
	...
	TelephoneNumber string `protobuf:"bytes,5,opt,name=telephone_number,json=telephoneNumber,proto3" form:"telephone_number" json:"telephone_number,omitempty" query:"telephone_number"` // 收件人电话
	Name            string `protobuf:"bytes,6,opt,name=name,proto3" form:"name" json:"name,omitempty" query:"name"`                                                                      // 收件人姓名
}
...
type PlaceOrderReq struct {
	...
	UserId       uint32       `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id,omitempty" query:"user_id"`                              // 用户 ID
	UserCurrency string       `protobuf:"bytes,2,opt,name=user_currency,json=userCurrency,proto3" form:"user_currency" json:"user_currency,omitempty" query:"user_currency"` // 用户的货币类型
	Address      *Address     `protobuf:"bytes,3,opt,name=address,proto3" form:"address" json:"address,omitempty" query:"address"`                                           // 用户的地址信息
	Email        string       `protobuf:"bytes,4,opt,name=email,proto3" form:"email" json:"email,omitempty" query:"email"`                                                   // 用户的邮箱
	OrderItems   []*OrderItem `protobuf:"bytes,5,rep,name=order_items,json=orderItems,proto3" form:"order_items" json:"order_items,omitempty" query:"order_items"`           // 订单中的商品列表
}
...
type OrderItem struct {
	...
	ProductId int64 `protobuf:"varint,1,opt,name=product_id,json=productId,proto3" form:"product_id" json:"product_id,omitempty" query:"product_id"` // 商品ID
	Quantity  int32 `protobuf:"varint,2,opt,name=quantity,proto3" form:"quantity" json:"quantity,omitempty" query:"quantity"`                        // 商品数量
	Cost      int64 `protobuf:"varint,3,opt,name=cost,proto3" form:"cost" json:"cost,omitempty" query:"cost"`                                        // 商品的单价。
}
...
type OrderResult struct {
	...
	OrderId string `protobuf:"bytes,1,opt,name=order_id,json=orderId,proto3" form:"order_id" json:"order_id,omitempty" query:"order_id"` // 订单 ID。
}
...
type PlaceOrderResp struct {
	...
	Order *OrderResult `protobuf:"bytes,1,opt,name=order,proto3" form:"order" json:"order,omitempty" query:"order"` // 新建的订单信息
}
...
type Order struct {
	...
	OrderItems   []*OrderItem `protobuf:"bytes,1,rep,name=order_items,json=orderItems,proto3" form:"order_items" json:"order_items,omitempty" query:"order_items"`           // 订单中的商品列表
	OrderId      string       `protobuf:"bytes,2,opt,name=order_id,json=orderId,proto3" form:"order_id" json:"order_id,omitempty" query:"order_id"`                          // 订单 ID
	UserId       uint32       `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id,omitempty" query:"user_id"`                              // 用户 ID
	UserCurrency string       `protobuf:"bytes,4,opt,name=user_currency,json=userCurrency,proto3" form:"user_currency" json:"user_currency,omitempty" query:"user_currency"` // 货币类型
	Address      *Address     `protobuf:"bytes,5,opt,name=address,proto3" form:"address" json:"address,omitempty" query:"address"`                                           // 地址信息
	Email        string       `protobuf:"bytes,6,opt,name=email,proto3" form:"email" json:"email,omitempty" query:"email"`                                                   // 邮箱
	CreatedAt    string       `protobuf:"bytes,7,opt,name=created_at,json=createdAt,proto3" form:"created_at" json:"created_at,omitempty" query:"created_at"`                // 订单创建时间
	UpdateAt     string       `protobuf:"bytes,8,opt,name=update_at,json=updateAt,proto3" form:"update_at" json:"update_at,omitempty" query:"update_at"`                     // 订单最后更新时间
}
...
type ListOrderResp struct {
	...
	Orders []*Order `protobuf:"bytes,1,rep,name=orders,proto3" form:"orders" json:"orders,omitempty" query:"orders"` // 用户的订单列表
}
...
type MarkOrderPaidResp struct {
	...
	Status string `protobuf:"bytes,1,opt,name=status,proto3" form:"status" json:"status,omitempty" query:"status"` // 状态，"success" 或 "error"。
}
...
type UpdateOrderReq struct {
	...
	OrderId string   `protobuf:"bytes,1,opt,name=order_id,json=orderId,proto3" form:"order_id" json:"order_id,omitempty" query:"order_id"` // 订单 ID
	Address *Address `protobuf:"bytes,2,opt,name=address,proto3" form:"address" json:"address,omitempty" query:"address"`                  // 新的地址信息
	Email   string   `protobuf:"bytes,3,opt,name=email,proto3" form:"email" json:"email,omitempty" query:"email"`                          // 新的邮箱
}
...
type CancelOrderResp struct {
	...
	Success bool `protobuf:"varint,1,opt,name=success,proto3" form:"success" json:"success,omitempty" query:"success"` // 是否取消成功
}
...
var file_order_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2b, 0x0a, 0x11, 0x4d, 0x61, 0x72,
	0x6b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x61, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16,
	0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x6b, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02,
	...
	0x61, 0x69, 0x6c, 0x22, 0x2b, 0x0a, 0x0f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64,
	...
	0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xc1, 0x02, 0x0a, 0x0c, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x50,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x36, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72,
	...
	0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x42,
	...
	0x73, 0x70, 0x12, 0x3c, 0x0a, 0x0b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x12, 0x15, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x12, 0x3c, 0x0a, 0x0b, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	...
	0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x42, 0x16,
	0x5a, 0x14, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x5f, 0x67, 0x65, 0x6e,
...
var file_order_proto_depIdxs = []int32{
	...
	10, // 10: order.OrderService.UpdateOrder:input_type -> order.UpdateOrderReq
	12, // 11: order.OrderService.CancelOrder:input_type -> order.CancelOrderReq
	...
	11, // 15: order.OrderService.UpdateOrder:output_type -> order.UpdateOrderResp
	13, // 16: order.OrderService.CancelOrder:output_type -> order.CancelOrderResp
