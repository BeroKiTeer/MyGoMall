...
type CreditCardInfo struct {
	...
	CreditCardNumber          string `protobuf:"bytes,1,opt,name=credit_card_number,json=creditCardNumber,proto3" form:"credit_card_number" json:"credit_card_number,omitempty" query:"credit_card_number"`                                                   // 信用卡号
	CreditCardCvv             int32  `protobuf:"varint,2,opt,name=credit_card_cvv,json=creditCardCvv,proto3" form:"credit_card_cvv" json:"credit_card_cvv,omitempty" query:"credit_card_cvv"`                                                                 // 信用卡 CVV
	CreditCardExpirationYear  int32  `protobuf:"varint,3,opt,name=credit_card_expiration_year,json=creditCardExpirationYear,proto3" form:"credit_card_expiration_year" json:"credit_card_expiration_year,omitempty" query:"credit_card_expiration_year"`      // 信用卡到期年份
	CreditCardExpirationMonth int32  `protobuf:"varint,4,opt,name=credit_card_expiration_month,json=creditCardExpirationMonth,proto3" form:"credit_card_expiration_month" json:"credit_card_expiration_month,omitempty" query:"credit_card_expiration_month"` // 信用卡到期月份
}
...
type ChargeReq struct {
	...
	Amount     float64         `protobuf:"fixed64,1,opt,name=amount,proto3" form:"amount" json:"amount,omitempty" query:"amount"`                                   // 支付金额
	CreditCard *CreditCardInfo `protobuf:"bytes,2,opt,name=credit_card,json=creditCard,proto3" form:"credit_card" json:"credit_card,omitempty" query:"credit_card"` // 信用卡信息
	OrderId    string          `protobuf:"bytes,3,opt,name=order_id,json=orderId,proto3" form:"order_id" json:"order_id,omitempty" query:"order_id"`                // 订单 ID
	UserId     uint32          `protobuf:"varint,4,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id,omitempty" query:"user_id"`                    // 用户 ID
}
...
type ChargeResp struct {
	...
	TransactionId string `protobuf:"bytes,1,opt,name=transaction_id,json=transactionId,proto3" form:"transaction_id" json:"transaction_id,omitempty" query:"transaction_id"` // 交易 ID
}
...
var file_payment_proto_rawDesc = []byte{
	...
	0x00, 0x42, 0x18, 0x5a, 0x16, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x5f,
